...
While I do intend to follow semver for the API, I don't not make
guarantees about the format of output to stdout or stderr. It is not intended
that one should try to parse the stdout/stderr output generated by spurs.
